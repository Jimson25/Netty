package com.bdht.netty.codec;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class StudentPOJO {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     *表示Student类中有一个属性，类型为int32（protobuf的类型，在java中对应的是int） 1表示属性序号
     * </pre>
     *
    ...
    /**
     * <pre>
     *表示有一个name属性，类型为string（protobuf）
     * </pre>
     *
